...
export default function GithubRepoCard({ repo }) {
  ...
  return (
		<div>
          ...
          {repo.languages && <ProjectLanguages className="repo-languages" logos={repo.languages } />}
				</div>
				<div className="repo-stats">
          <div className="repo-left-stat">
            <span>
              <div className="language-color" style={{ backgroundColor: repo.primaryLanguage.color }}></div>
